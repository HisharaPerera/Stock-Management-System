...
<!-- Navigation -->
	...
	<?php
         if(isset($_POST['add']))
         {
            ...
            $reoder_level = $_POST['reoder_level'];
            $type_code = $_POST['type_code'];
            
            $sql = "UPDATE item ". "SET item_name = '$item_name', description = '$description', quantity = '$quantity', reoder_level = '$reoder_level', type_code = '$type_code' ". "WHERE item_id = '$item_id'" ;
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-12 text-center">
                    <h2 class="section-heading">Update Item</h2>
			...
			<div class="col-md-3"></div>
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" id="item_id" name="item_id" placeholder="Item ID" required>
                   <br>
                   ...
                   <br>
                     ...
                     <input type="text" class="form-control" id="reoder_level" name="reoder_level" placeholder="Reoder Level" required>
                   <br>
                   ...
                   <br>
                            ...
                            <div class="col-lg-12 text-center">
                                <div id="success"></div>
								<div class="row">
                                <button type="submit"  name="add" id="add" value="Add Item" class="btn btn-xl">Update Item</button>
