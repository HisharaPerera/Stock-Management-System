...
<!-- Navigation -->
	...
	<?php
         if(isset($_POST['add']))
         {
            ...
            $sql = "INSERT INTO item ". "(item_name,description, quantity, reoder_level, type_code) ". "VALUES('$item_name','$description',$quantity, $reoder_level, $type_code)";
            ...
            $message = "You have successfully Added Item..!!";
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-12 text-center">
                    <h2 class="section-heading">Add Item</h2>
                ...
                <div class="col-md-6">
                   ...
                   <br>
                            ...
                            <div class="col-lg-12 text-center">
                                <div id="success"></div>
								<div class="row">
                                <button type="submit"  name="add" id="add" value="Add Item" class="btn btn-xl">Add Item</button>
