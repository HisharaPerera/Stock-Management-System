...
<!-- Navigation -->
	...
	<?php
         if(isset($_POST['add']))
         {
            ...
            $sql = "INSERT INTO item_type ". "(type_code, type_field) ". "VALUES('$type_code','$type_field')";
            ...
            $message = "You have successfully Added Item Type..!!";
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-12 text-center">
                    <h2 class="section-heading">Add Item Type</h2>
                ...
                <div class="col-md-6">
                    ...
                    <br><br><br>
                            ...
                            <div class="col-lg-12 text-center">
                                <div id="success"></div>
								<div class="row">
                                <button name="search" id="search" value="Search Item" class="btn btn-xl">Add Item Type</button>
