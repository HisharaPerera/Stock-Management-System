...
<head>
	...
	<?php
		...
		$records = viewAll($connect,$id,"paperID");
                ...
                <div class="col-md-8">
					...
					<div class="col-md-4">
						...
						?>
							...
							<li class="list-group-item"><b>Paper Name </b><?php //echo $row[0]; ?></li>
							<li class="list-group-item"><b>Paper Type </b></li>
							<li class="list-group-item"><b>Paper Size </b></li>
							<li class="list-group-item"><b>Thickness </b></li>
							<li class="list-group-item"><b>Colour </b></li>
					...
					<div class="col-md-8">
						...
						?>
							...
							<li class="list-group-item">&nbsp; <?php echo $row[6]; ?></li>
							<li class="list-group-item">&nbsp; <?php echo $row[8]; ?></li>
						...
						?>
                            ...
                            <div class="col-lg-12 text-center">
								...
								<button type="reset" class="btn btn-xl">Delete</button>
								</div>
                            </div>
                        </div>
                    </form>
...
<p style="color : white;"></p>
						<img src="<?php echo $m; ?>" alt="No picture" style="width:200px;height:200px;">
					</div>
                </div>
            </div>
        </div>
