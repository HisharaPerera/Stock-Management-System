    ...
    <header>
        <div class="container">
			...
			?>
				...
				<a href="viewPaper.php?id=<?php echo $row[0]; ?>" class="list-group-item"><?php echo $row[1]; ?></a>
					<td></td>
			...
			?>
				...
				<a href="viewInk.php?id=<?php echo $row[0]; ?>" class="list-group-item"><?php echo $row[1]." - ".$row[2]; ?></a>
					<td></td>
			...
			?>
				...
				<a href="viewHandle.php?id=<?php echo $row[0]; ?>" class="list-group-item"><?php echo $row[1]." - ".$row[2]; ?></a>
					<td></td>
