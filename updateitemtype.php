...
<!-- Navigation -->
	...
	<?php
         if(isset($_POST['add']))
         {
            ...
            $sql = "UPDATE item_type ". "SET type_field = '$type_field'". "WHERE type_code = '$type_code'" ;
            ...
            $message = "You have successfully Updated Item Type..!!";
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-12 text-center">
                    <h2 class="section-heading">Update Item Type</h2>
			...
			<div class="col-md-3"></div>
                <div class="col-md-6">
                   ...
                   <br>
                     ...
                     <input type="text" class="form-control" id="type_field" name="type_field" placeholder="Type Field">
                   <br>
                            ...
                            <div class="col-lg-12 text-center">
                                <div id="success"></div>
								<div class="row">
                                <button type="submit"  name="add" id="add" value="Add Item" class="btn btn-xl">Update Item Type</button>
