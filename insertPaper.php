    ...
    <section id="contact">
        <div class="container">
			...
			<div class="col-md-3"></div>
                <div class="col-md-6">
                    <form method="post" action="paper.php" name="sentMessage" id="contactForm" enctype="multipart/form-data" novalidate>
                        
			<span></span>
			<input type="text" name="paperName" id="paperName" class="form-control" placeholder="Paper Name*" required>
			<br>
			<span></span>
			<select id="paperType" name="paperType" class="form-control" placeholder="Paper Type">
			<option selected disabled>Paper Type</option>
			<?php while($row = $paperType->fetch_row()){ ?>
			<option><?php echo $row[1]; ?></option>
			<?php } ?>
			</select>
			<br>
			<span></span>
			<input type="text" name="paperSize" id="paperSize" class="form-control" placeholder="Paper Size">
			<br>
			<span></span>
			<input type="text" name="density" id="density" class="form-control" placeholder="Thickness*" required>
			<br>
			<span></span>
