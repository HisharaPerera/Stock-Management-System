...
<!-- Navigation -->
	...
	<?php
         if(isset($_POST['add']))
         {
            ...
            $sql = "DELETE FROM item_type WHERE type_code = '$type_code'";
            ...
            $message = "You have successfully Delete Item Type..!!";
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-12 text-center">
                    <h2 class="section-heading">Delete Item Type</h2>
                ...
                <div class="col-md-6">
                   ...
                   <br>
                            ...
                            <div class="col-lg-12 text-center">
                                <div id="success"></div>
								<div class="row">
                                <button type="submit"  name="add" id="add" value="Add Item" class="btn btn-xl">Delete Item Type</button>
